...
sigma = 0.15  # Radio físico de cada disco rígido 
...
df_hits.to_csv("miniproyecto_1/data/resultados_ds_N4_1e6.csv", index=False, encoding="utf-8") #Cambiar el nombre para guardar los diferentes archivos guardados en /data
